...
export namespace Spotify {
    ...
    export async function getPlaylist(playlist_id: string, opts: {"limit"?: number, "offset"?: number} & Opts): Promise<UserPlaylist | ResponseError> {
        try {
            ...
            const playlist_data: UserPlaylist = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`,
    ...
    export async function getAlbum(album_id: string, opts: {"limit"?: number, "offset"?: number} & Opts): Promise<Album | ResponseError> {
        try {
            ...
            const album_data: Album = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`,
    ...
    export async function getCollection(opts: {"limit"?: number, "offset"?: number} & Opts): Promise<Collection | ResponseError> {
        try {
            ...
            const collection_data: Collection = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`,
    ...
    export async function getProfileAccountAttributes(opts: Opts){
        try {
            ...
            const account_data: ProfileData = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`,
    ...
    export async function getArtist(url: string, opts: {"locale"?: string, "include_pre_releases"?: boolean} & Opts): Promise<Artist | ResponseError>{
        try{
            ...
            const artist_data = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`, 
    ...
    export async function search(query: string, opts: {
        ...
        try{
            ...
            const search_data = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`, 
            { 'method': "GET", headers }) ).json() as SearchResult;
            return search_data;
        } catch (error) { return { "error": String(error) }; }
    }

    export async function getHome(opts: {
        "sp_t_cookie": Cookie,
        "time_zone"?: string
        "country"?: string,
        ...
        try{
            ...
            const home_data = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`, 
    ...
    export async function getAllPlaylistsFromAccount(opts: Opts, limit: number = 10): Promise<Map<string, string> | ResponseError>{
        try {
            ...
            const library: Library = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`, 
    ...
    export async function areTracksInLibrary(opts: {"uris": string[]} & Opts){
        try {
            ...
            const in_library: InLibrary = await ( await fetch(`https://api-partner.spotify.com/pathfinder/v1/query?${encodeParams(params)}`, 
            { 'method': "GET", headers }) ).json();
            return in_library;
        } catch (error) { return { "error": String(error) }; }
    }
