...
export interface CreatePlaylistEndpoint {
    params: string
    createPlaylistDialog: CreatePlaylistDialog
}

export interface CreatePlaylistDialog {
    createPlaylistDialogRenderer: CreatePlaylistDialogRenderer
}

export interface CreatePlaylistDialogRenderer {
...
export interface NavigationEndpoint2 {
    clickTrackingParams: string
    createPlaylistEndpoint?: CreatePlaylistEndpoint2
    browseEndpoint?: BrowseEndpoint4
}

export interface CreatePlaylistEndpoint2 {
    params: string
    createPlaylistDialog: CreatePlaylistDialog2
}

export interface CreatePlaylistDialog2 {
    createPlaylistDialogRenderer: CreatePlaylistDialogRenderer2
}

export interface CreatePlaylistDialogRenderer2 {
